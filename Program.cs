    ...
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            do
            {
                ...
                Console.WriteLine("3. View Novel And Magazine");
                ...
                switch (choose)
                {
                    case 1:
                        ...
                        do
                        {
                            ...
                            Console.WriteLine("0. Exit");
                            Console.Write("Enter option: ");
                            optionNovel = int.Parse(Console.ReadLine());
                    ...
                    case 2:
                        ...
                        do
                        {
                            ...
                            Console.WriteLine("0. Exit");
                            Console.Write("Enter option: ");
                            optionMagazine = int.Parse(Console.ReadLine());

                            switch (optionMagazine)
                            {
                                case 1:
